...
L["CURRENCY_VENDOR_NEAREST"] = "Fastest known vendor: %s"
...
L["TOOLTIP_CURRENCY_VENDORS"] = "Find the fastest known route to a vendor accepting a selected currency."
...
if GetLocale() == "deDE" then
    ...
    L["CURRENCY_VENDOR_NEAREST"] = "Schnellster bekannter Händler: %s"
    ...
    L["TOOLTIP_CURRENCY_VENDORS"] = "Finde den schnellsten bekannten Weg zu einem Händler für die gewählte Währung."
