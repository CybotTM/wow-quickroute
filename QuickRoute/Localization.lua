...
L["MULTI_HINT"] = "Paste up to 20 waypoints, one per line: /way #84 52.1 73.4 Destination\nChoose the fastest next stop or follow input order. Mark each stop reached to continue."
L["MULTI_FASTEST_NEXT"] = "Choose fastest next stop (does not optimize the whole trip)"
...
L["CURRENCY_VENDOR_NONE"] = "No vendor recorded for that currency. Visit a vendor to learn its location and accepted currencies."
...
if GetLocale() == "deDE" then
    ...
    L["MULTI_HINT"] = "Bis zu 20 Wegpunkte einfügen, einen pro Zeile: /way #84 52.1 73.4 Ziel\nDas schnellste nächste Ziel wählen oder der Eingabereihenfolge folgen. Erreichte Ziele bestätigen, um fortzufahren."
    L["MULTI_FASTEST_NEXT"] = "Schnellstes nächstes Ziel (optimiert nicht die gesamte Reise)"
    ...
    L["CURRENCY_VENDOR_NONE"] = "Kein Händler für diese Währung gespeichert. Besuche einen Händler, um seinen Standort und seine akzeptierten Währungen zu erfassen."
