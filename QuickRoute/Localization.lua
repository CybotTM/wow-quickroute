...
L["ROUTE_FAIL_STEP_REJECTED"] = "The only known route uses a step you refused. Choosing another destination forgets your refusals."
L["STEP_REJECT"] = "Cannot use"
L["STEP_REJECT_TT"] = "Refuse this step and look for another route to the same destination. The refusal lasts until you choose a different destination, and records nothing about your character."
...
if GetLocale() == "deDE" then
    ...
    L["ROUTE_FAIL_STEP_REJECTED"] = "Die einzige bekannte Route nutzt einen Schritt, den du abgelehnt hast. Ein anderes Ziel verwirft deine Ablehnungen."
    L["STEP_REJECT"] = "Nicht nutzbar"
    L["STEP_REJECT_TT"] = "Diesen Schritt ablehnen und eine andere Route zum selben Ziel suchen. Die Ablehnung gilt, bis du ein anderes Ziel wählst, und speichert nichts über deinen Charakter."
