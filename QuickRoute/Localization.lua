...
L["JOURNEY_HELD_BY"] = "A detour to %s is in force. End it first, or clear the route."
...
if GetLocale() == "deDE" then
    ...
    L["JOURNEY_HELD_BY"] = "Ein Umweg nach %s ist aktiv. Beende ihn zuerst oder lösche die Route."
