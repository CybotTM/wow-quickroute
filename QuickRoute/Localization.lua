...
L["ROUTE_FAIL_STEP_REJECTED"] = "The only known route uses a step you rejected. Restore it to route through it again."
L["STEP_REJECT"] = "Cannot use"
L["STEP_REJECT_TT"] = "Refuse this step for this session and look for another route to the same destination. This does not record anything about your character."
...
if GetLocale() == "deDE" then
    ...
    L["ROUTE_FAIL_STEP_REJECTED"] = "Die einzige bekannte Route nutzt einen Schritt, den du abgelehnt hast. Nimm ihn wieder an, um darüber zu routen."
    L["STEP_REJECT"] = "Nicht nutzbar"
    L["STEP_REJECT_TT"] = "Diesen Schritt für diese Sitzung ablehnen und eine andere Route zum selben Ziel suchen. Das speichert nichts über deinen Charakter."
