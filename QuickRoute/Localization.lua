...
L["MULTI_IMPORT_AMBIGUOUS_COORDS"] = "Line %d mixes both decimal marks and can be read two ways. Write both values the same way."
...
if GetLocale() == "deDE" then
    ...
    L["MULTI_IMPORT_AMBIGUOUS_COORDS"] = "Zeile %d mischt beide Dezimalzeichen und lässt sich auf zwei Arten lesen. Bitte beide Werte gleich schreiben."
