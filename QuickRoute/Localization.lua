...
L["SETTINGS_AUTO_WAYPOINT"] = "Automatic waypoints"
L["SETTINGS_CONSIDER_CD"] = "Include cooldowns"
L["SETTINGS_CONSIDER_CD_TT"] = "Factor teleport cooldowns into route calculations"
L["SETTINGS_AUTO_DEST"] = "Automatic quest routes"
...
L["SETTINGS_WINDOW_SCALE_TT"] = "Preferred size of the route and teleport windows (75%-150%). Windows automatically shrink when needed to fit the screen."
...
L["DUNGEON_NO_ENTRANCE_COORDS"] = "No entrance coordinates available"
...
L["DEST_SEARCH_ATT"] = "ATT items and vendors"
L["ATT_SEARCH_LOADING"] = "Searching ATT..."
L["ATT_SEARCH_MORE"] = "Search limit reached. Refine your search."
L["ATT_SEARCH_HINT"] = "Names already loaded in WoW or ATT are searchable; an item link or ID also works."
L["ATT_SEARCH_ITEM_SOURCE"] = "Source for %s"
L["ATT_SEARCH_NPC"] = "NPC/vendor"
L["ATT_SEARCH_SOURCE_TT"] = "Route to this source recorded by ATT; availability is checked when selected."
L["ATT_SEARCH_PURCHASE_TT"] = "You can visit this source. Purchasing may require additional reputation or renown."
...
L["ACQUISITION_HELP"] = "How to obtain"
L["ACQUISITION_CLICK_HINT"] = "Left-click: details in ATT, if available. Right-click: QuickRoute acquisition help and source routing."
L["ACQUISITION_VENDOR_ROUTE"] = "Route to vendor"
L["ACQUISITION_VENDOR_UNKNOWN"] = "An exact location for this acquisition source is not yet known."
L["ACQUISITION_COPY_LINK"] = "Wowhead details: select the link and press Ctrl+C."
L["ACQUISITION_ATT_HINT"] = "Optional: ALL THE THINGS adds collection and source details to item tooltips."
L["ACQUISITION_OPEN_ATT"] = "Open in ATT"
L["ACQUISITION_ATT_UNAVAILABLE"] = "ATT could not open this entry. The available acquisition details are shown here."
L["ACQUISITION_SOURCE"] = "Acquisition source"
L["ACQUISITION_SOURCE_ROUTE"] = "Route to source"
L["ACQUISITION_ATT_SOURCE"] = "One source recorded in ALL THE THINGS"
L["ACQUISITION_NPC_FALLBACK"] = "NPC %d"
L["ACQUISITION_QUEST_GROUP"] = "Prerequisite quests (%d of %d): %s"
L["ACQUISITION_COST"] = "Cost"
...
L["DEST_RANDOM_DELVE"] = "Random Delve"
...
L["ACQUISITION_UNOBTAINABLE"] = "Currently unobtainable"
L["ACQUISITION_UNOBTAINABLE_SHORT"] = "Unobtainable"
L["ACQUISITION_REPUTATION_MIN"] = "%s: at least %g reputation"
L["ACQUISITION_REPUTATION_MAX"] = "%s: below %g reputation"
L["ACQUISITION_RENOWN_MIN"] = "%s: Renown %g required"
L["ACQUISITION_FACTION_FALLBACK"] = "Faction %d"
L["ACQUISITION_UNOBTAINABLE_HINT"] = "According to ALL THE THINGS, the recorded sources are no longer obtainable. Previously learned teleports remain usable."
...
-- Multi-destination trips and observed currency vendors (English fallback).
L["STEP_USE_TRANSLOCATION_PAD"] = "Use the translocation pad to %s"
L["STEP_JUMP_TO"] = "Jump into the central shaft to %s"
L["CHOOSE_DESTINATION"] = "Choose: %s"
L["QUEST_ROUTE_USAGE"] = "Usage: /qr quest <questID> [target|giver]"
L["DEST_SEARCH_CATALOG"] = "NPCs & quest locations"
L["CATALOG_GIVER"] = "Quest giver"
L["CATALOG_REFERENCE"] = "Quest reference"
L["CATALOG_NPC"] = "NPC"
L["CATALOG_LOCATION"] = "Catalogue location (AllTheThings); phase and availability can change."
L["CATALOG_MORE"] = "More matches: narrow your search."
L["CATALOG_SEARCH_LANGUAGE"] = "No match? Try the English name or quest/NPC ID. Translated catalogue names are not yet fully available."
L["CURRENCY_VENDOR_MOVED"] = "Position changed during comparison. Stop moving and try again."
L["CURRENCY_VENDOR_SELECT"] = "Vendors for %s"
L["CURRENCY_VENDOR_BACK"] = "Back to currencies"
L["CURRENCY_VENDOR_BACK_TT"] = "Click to choose another currency."
L["CURRENCY_VENDOR_OPEN_TT"] = "Click to view vendors for this currency."
L["CURRENCY_VENDOR_KNOWN"] = "Known vendor"
L["CURRENCY_VENDOR_OBSERVED_SHORT"] = "Visited vendor"
L["PHASE_TITLE"] = "Zone phases"
L["PHASE_UNKNOWN"] = "Phase unknown"
L["PHASE_PAST"] = "Past"
L["PHASE_PRESENT"] = "Present"
L["PHASE_AUTO"] = "Automatic"
L["PHASE_ASSUMED"] = "Assumed: %s"
L["PHASE_DETECTED"] = "Detected: %s"
L["PHASE_HINT"] = "If a remote zone's phase is unknown, select your current phase. Assumptions last this session and apply only when the client cannot report it. Change the actual phase by speaking to Zidormi."
L["STEP_CHANGE_PHASE_TO"] = "Speak to Zidormi: %s"
L["MULTI_POSITION_CHANGED"] = "Position changed during comparison. Stop moving and try again."
L["MULTI_MATRIX_PROGRESS"] = "Comparing trip legs: %d / %d"
L["MULTI_ITINERARY"] = "Remaining stops"
L["MULTI_EMPTY"] = "Paste waypoints or import your TomTom collection to begin."
L["MULTI_RESUME"] = "Saved trip restored. Choose Reached / next to resume routing."
L["MULTI_TOUR_ESTIMATE"] = "Tour estimate: %s (%s; excludes personal teleport cooldowns)."
L["MULTI_EXACT"] = "shortest estimated order"
L["MULTI_HEURISTIC"] = "optimized estimate"
L["MULTI_LIVE_FALLBACK"] = "No complete reusable tour found; selecting the next stop with live teleports."
L["MULTI_TITLE"] = "Multi-destination trip"
L["MULTI_HINT"] = "Paste up to 20 waypoints, one per line: /way #84 52.1 73.4 Destination\nOptimize the visit order or follow input order. Mark each stop reached to continue."
L["MULTI_FASTEST_NEXT"] = "Optimize the whole trip (reusable routes; live teleports per leg)"
L["MULTI_START"] = "Route list"
L["MULTI_TOMTOM"] = "From TomTom"
L["MULTI_NEXT"] = "Reached / next"
L["MULTI_CLEAR"] = "Clear trip"
L["MULTI_PROGRESS"] = "Stop %d of %d: %s"
L["MULTI_COMPLETE"] = "Trip complete."
L["MULTI_INVALID"] = "Use /way mapID x y with coordinates from 0 to 100, one destination per line."
L["MULTI_LIMIT"] = "A trip supports 1 to 20 destinations. Split longer lists into smaller trips."
L["MULTI_NO_TOMTOM"] = "No active TomTom waypoints found."
L["ROUTE_FAIL_INVALID_DESTINATION"] = "That destination has no usable map position."
L["ROUTE_FAIL_POSITION_UNAVAILABLE"] = "Your position is not available yet. This usually resolves after the loading screen."
L["ROUTE_FAIL_GRAPH_UNAVAILABLE"] = "The travel graph is not ready yet. Try again in a moment."
L["ROUTE_FAIL_SEARCH_LIMIT"] = "The search hit its budget before finishing. This does not mean the destination is unreachable."
L["ROUTE_FAIL_BLOCKED"] = "Every known route needs something this character does not have yet."
L["ROUTE_FAIL_NO_CONNECTION"] = "QuickRoute knows no connection to that destination."
L["ROUTE_FAIL_INTERNAL"] = "The route could not be built. See the debug log."
L["ROUTE_FAIL_STEP_REJECTED"] = "The only known route uses a step you refused. Right-click Refresh to take your refusals back."
L["DUNGEON_OFFER_READY"] = "Group accepted for %s. Open QuickRoute to route there."
L["STEP_REJECT"] = "Cannot use"
L["STEP_REJECT_TT"] = "Refuse this step and look for another route to this destination. It applies to this destination only, lasts for the session, and records nothing about your character."
L["STEP_REJECT_CLEARED"] = "%d refused steps restored."
L["STEP_REJECT_RESTORE_TT"] = "Right-click to take back %d refused steps."
L["STEP_REJECT_DONE"] = "Step refused: %s. Recalculating."
L["ROUTE_FAIL_RETRY_HINT"] = "Try again in a moment; this is a temporary state, not a missing connection."
L["MULTI_IMPORT_SUMMARY"] = "Imported %d of %d lines."
L["MULTI_IMPORT_SKIPPED"] = "Line %d is not a waypoint and was skipped: %s"
L["MULTI_IMPORT_BAD_COORDS"] = "Line %d holds no coordinate pair from 0 to 100."
L["MULTI_IMPORT_UNKNOWN_MAP"] = "Line %d: '%s' matches no zone QuickRoute knows. Use /way #mapID x y."
L["MULTI_IMPORT_AMBIGUOUS_MAP"] = "Line %d: '%s' matches more than one zone. Use /way #mapID x y."
L["MULTI_IMPORT_MORE"] = "%d more lines were reported but are not shown."
L["MULTI_IMPORT_NO_POSITION"] = "Line %d gives no map ID and the current map is unknown."
L["DEST_SEARCH_CURRENCIES"] = "Currency vendors"
L["CURRENCY_VENDOR_NEAREST"] = "Fastest to reach: %s"
L["CURRENCY_VENDOR_FASTEST"] = "Fastest to reach"
L["CURRENCY_VENDOR_TRAVEL_TIME_TT"] = "Compares estimated travel time to eligible vendors, including available teleports and transport. Uses known vendor locations; availability can change."
L["CURRENCY_VENDOR_NONE"] = "No eligible known vendor for this currency. Visiting merchants adds verified observations to the catalogue."
L["CURRENCY_VENDOR_OBSERVED"] = "Observed vendor location; stock, phasing and access may change."
L["DEST_SEARCH_ALL_QUESTS"] = "Quests & map objectives"
L["DESTINATION_UNAVAILABLE"] = "No verified destination coordinates are available."
L["DESTINATION_INACCESSIBLE"] = "This destination is no longer available to this character."
L["CURRENCY_VENDORS"] = "Currency vendors"
L["MULTI_ROUTE"] = "Multi-route"
L["DUNGEON_OTHER"] = "Other entrances"
L["TOOLTIP_CURRENCY_VENDORS"] = "Compare estimated travel times to vendors for a selected currency, including available teleports."
L["TOOLTIP_MULTI_ROUTE"] = "Plan a trip through multiple destinations."
...
if GetLocale() == "deDE" then
    L["STEP_USE_TRANSLOCATION_PAD"] = "Translokationsplattform nach %s benutzen"
    L["STEP_JUMP_TO"] = "Durch den zentralen Schacht nach %s springen"
    L["CHOOSE_DESTINATION"] = "Auswählen: %s"
    L["QUEST_ROUTE_USAGE"] = "Verwendung: /qr quest <Quest-ID> [target|giver]"
    L["DEST_SEARCH_CATALOG"] = "NSCs & Questorte"
    L["CATALOG_GIVER"] = "Questgeber"
    L["CATALOG_REFERENCE"] = "Questort (Referenz)"
    L["CATALOG_NPC"] = "NSC"
    L["CATALOG_LOCATION"] = "Katalogposition (AllTheThings); Phase und Verfügbarkeit können sich ändern."
    L["CATALOG_MORE"] = "Weitere Treffer: Suche eingrenzen."
    L["CATALOG_SEARCH_LANGUAGE"] = "Kein Treffer? Versuche den englischen Namen oder die Quest-/NSC-ID. Übersetzte Katalognamen sind noch nicht vollständig verfügbar."
    L["CURRENCY_VENDOR_MOVED"] = "Position während des Vergleichs geändert. Stehen bleiben und erneut versuchen."
    L["CURRENCY_VENDOR_SELECT"] = "Händler für %s"
    L["CURRENCY_VENDOR_BACK"] = "Zurück zu den Währungen"
    L["CURRENCY_VENDOR_BACK_TT"] = "Klicken, um eine andere Währung auszuwählen."
    L["CURRENCY_VENDOR_OPEN_TT"] = "Klicken, um Händler für diese Währung anzuzeigen."
    L["CURRENCY_VENDOR_KNOWN"] = "Bekannter Händler"
    L["CURRENCY_VENDOR_OBSERVED_SHORT"] = "Besuchter Händler"
    L["PHASE_TITLE"] = "Gebietsphasen"
    L["PHASE_UNKNOWN"] = "Phase unbekannt"
    L["PHASE_PAST"] = "Vergangenheit"
    L["PHASE_PRESENT"] = "Gegenwart"
    L["PHASE_AUTO"] = "Automatisch"
    L["PHASE_ASSUMED"] = "Angenommen: %s"
    L["PHASE_DETECTED"] = "Erkannt: %s"
    L["PHASE_HINT"] = "Bei unbekannter Gebietsphase die aktuelle Phase auswählen. Die Annahme gilt für diese Sitzung und nur ohne Client-Auskunft. Die tatsächliche Phase ändert Zidormi im Gespräch."
    L["STEP_CHANGE_PHASE_TO"] = "Mit Zidormi sprechen: %s"
    L["MULTI_POSITION_CHANGED"] = "Position während des Vergleichs geändert. Stehen bleiben und erneut versuchen."
    L["MULTI_MATRIX_PROGRESS"] = "Reiseetappen vergleichen: %d / %d"
    L["MULTI_ITINERARY"] = "Verbleibende Ziele"
    L["MULTI_EMPTY"] = "Wegpunkte einfügen oder die TomTom-Sammlung importieren."
    L["MULTI_RESUME"] = "Gespeicherte Reise geladen. Mit Erreicht / weiter die Navigation fortsetzen."
    L["MULTI_TOUR_ESTIMATE"] = "Geschätzte Reise: %s (%s; ohne persönliche Teleport-Abklingzeiten)."
    L["MULTI_EXACT"] = "kürzeste geschätzte Reihenfolge"
    L["MULTI_HEURISTIC"] = "optimierte Schätzung"
    L["MULTI_LIVE_FALLBACK"] = "Keine vollständige wiederverwendbare Reise gefunden; nächstes Ziel mit aktuellen Teleports wählen."
    L["MULTI_TITLE"] = "Reise mit mehreren Zielen"
    L["MULTI_HINT"] = "Bis zu 20 Wegpunkte einfügen, einen pro Zeile: /way #84 52.1 73.4 Ziel\nBesuchsreihenfolge optimieren oder Eingabereihenfolge nutzen. Erreichte Ziele bestätigen."
    L["MULTI_FASTEST_NEXT"] = "Gesamte Reise optimieren (wiederverwendbare Wege; Teleports je Etappe)"
    L["MULTI_START"] = "Liste starten"
    L["MULTI_TOMTOM"] = "Aus TomTom"
    L["MULTI_NEXT"] = "Erreicht / weiter"
    L["MULTI_CLEAR"] = "Reise löschen"
    L["MULTI_PROGRESS"] = "Ziel %d von %d: %s"
    L["MULTI_COMPLETE"] = "Reise abgeschlossen."
    L["MULTI_INVALID"] = "Format: /way mapID x y mit Koordinaten von 0 bis 100, ein Ziel pro Zeile."
    L["MULTI_LIMIT"] = "Eine Reise unterstützt 1 bis 20 Ziele. Längere Listen bitte aufteilen."
    L["MULTI_NO_TOMTOM"] = "Keine aktiven TomTom-Wegpunkte gefunden."
    L["ROUTE_FAIL_INVALID_DESTINATION"] = "Dieses Ziel hat keine nutzbare Kartenposition."
    L["ROUTE_FAIL_POSITION_UNAVAILABLE"] = "Deine Position ist noch nicht verfügbar. Das klärt sich meist nach dem Ladebildschirm."
    L["ROUTE_FAIL_GRAPH_UNAVAILABLE"] = "Der Reisegraph ist noch nicht bereit. Bitte gleich noch einmal versuchen."
    L["ROUTE_FAIL_SEARCH_LIMIT"] = "Die Suche hat ihr Budget erreicht, bevor sie fertig war. Das Ziel ist deshalb nicht unerreichbar."
    L["ROUTE_FAIL_BLOCKED"] = "Jede bekannte Route verlangt etwas, das dieser Charakter noch nicht hat."
    L["ROUTE_FAIL_NO_CONNECTION"] = "QuickRoute kennt keine Verbindung zu diesem Ziel."
    L["ROUTE_FAIL_INTERNAL"] = "Die Route konnte nicht gebaut werden. Siehe Debug-Log."
    L["ROUTE_FAIL_STEP_REJECTED"] = "Die einzige bekannte Route nutzt einen Schritt, den du abgelehnt hast. Rechtsklick auf Aktualisieren nimmt Ablehnungen zurück."
    L["DUNGEON_OFFER_READY"] = "Gruppe für %s angenommen. QuickRoute öffnen, um dorthin zu routen."
    L["STEP_REJECT"] = "Nicht nutzbar"
    L["STEP_REJECT_TT"] = "Diesen Schritt ablehnen und eine andere Route zu diesem Ziel suchen. Gilt nur für dieses Ziel, für diese Sitzung, und speichert nichts über deinen Charakter."
    L["STEP_REJECT_CLEARED"] = "%d abgelehnte Schritte wiederhergestellt."
    L["STEP_REJECT_RESTORE_TT"] = "Rechtsklick nimmt %d abgelehnte Schritte zurück."
    L["STEP_REJECT_DONE"] = "Schritt abgelehnt: %s. Neuberechnung läuft."
    L["ROUTE_FAIL_RETRY_HINT"] = "Bitte gleich noch einmal versuchen. Das ist ein vorübergehender Zustand, keine fehlende Verbindung."
    L["MULTI_IMPORT_SUMMARY"] = "%d von %d Zeilen übernommen."
    L["MULTI_IMPORT_SKIPPED"] = "Zeile %d ist kein Wegpunkt und wurde übersprungen: %s"
    L["MULTI_IMPORT_BAD_COORDS"] = "Zeile %d enthält kein Koordinatenpaar von 0 bis 100."
    L["MULTI_IMPORT_UNKNOWN_MAP"] = "Zeile %d: '%s' ist keine QuickRoute bekannte Zone. Bitte /way #mapID x y verwenden."
    L["MULTI_IMPORT_AMBIGUOUS_MAP"] = "Zeile %d: '%s' passt auf mehrere Zonen. Bitte /way #mapID x y verwenden."
    L["MULTI_IMPORT_MORE"] = "%d weitere Zeilen wurden gemeldet, aber nicht angezeigt."
    L["MULTI_IMPORT_NO_POSITION"] = "Zeile %d nennt keine Karten-ID und die aktuelle Karte ist unbekannt."
    L["DEST_SEARCH_CURRENCIES"] = "Währungshändler"
    L["CURRENCY_VENDOR_NEAREST"] = "Am schnellsten erreichbar: %s"
    L["CURRENCY_VENDOR_FASTEST"] = "Am schnellsten erreichbar"
    L["CURRENCY_VENDOR_TRAVEL_TIME_TT"] = "Vergleicht die geschätzte Reisezeit zu zugänglichen Händlern, einschließlich verfügbarer Teleports und Transportwege. Berücksichtigt bekannte Händlerstandorte; die Verfügbarkeit kann sich ändern."
    L["CURRENCY_VENDOR_NONE"] = "Kein zugänglicher bekannter Händler für diese Währung. Händlerbesuche ergänzen den Katalog um beobachtete Standorte."
    L["CURRENCY_VENDOR_OBSERVED"] = "Beobachteter Händlerstandort; Angebot, Phase und Zugang können sich ändern."
    L["DEST_SEARCH_ALL_QUESTS"] = "Quests und Kartenziele"
    L["DESTINATION_UNAVAILABLE"] = "Keine bestätigten Zielkoordinaten verfügbar."
    L["DESTINATION_INACCESSIBLE"] = "Dieses Ziel ist für deinen Charakter nicht mehr verfügbar."
    L["CURRENCY_VENDORS"] = "Währungshändler"
    L["MULTI_ROUTE"] = "Mehrere Ziele"
    L["DUNGEON_OTHER"] = "Weitere Eingänge"
    L["TOOLTIP_CURRENCY_VENDORS"] = "Vergleiche die geschätzte Reisezeit zu Händlern für die gewählte Währung, einschließlich verfügbarer Teleports."
    L["TOOLTIP_MULTI_ROUTE"] = "Plane eine Reise mit mehreren Zielen."
    -- General
    L["ADDON_TITLE"] = "QuickRoute"
    ...
    L["SETTINGS_AUTO_WAYPOINT"] = "Wegpunkt automatisch setzen"
    L["SETTINGS_CONSIDER_CD"] = "Abklingzeiten beachten"
    L["SETTINGS_CONSIDER_CD_TT"] = "Teleport-Abklingzeiten in Routenberechnungen einbeziehen"
    L["SETTINGS_AUTO_DEST"] = "Quest-Routen automatisch"
    ...
    L["SETTINGS_WINDOW_SCALE_TT"] = "Gewünschte Größe der Routen- und Teleportfenster (75%-150%). Bei wenig Platz werden die Fenster automatisch an den Bildschirm angepasst."
    ...
    L["DUNGEON_NO_ENTRANCE_COORDS"] = "Keine Eingangskoordinaten vorhanden"
    ...
    L["DEST_SEARCH_ATT"] = "ATT: Gegenstände und Händler"
    L["ATT_SEARCH_LOADING"] = "ATT wird durchsucht..."
    L["ATT_SEARCH_MORE"] = "Suchgrenze erreicht. Suche eingrenzen."
    L["ATT_SEARCH_HINT"] = "Bereits in WoW oder ATT geladene Namen sind durchsuchbar; auch ein Gegenstandslink oder eine ID funktioniert."
    L["ATT_SEARCH_ITEM_SOURCE"] = "Bezugsquelle für %s"
    L["ATT_SEARCH_NPC"] = "NSC/Händler"
    L["ATT_SEARCH_SOURCE_TT"] = "Route zu dieser in ATT erfassten Bezugsquelle. Die Verfügbarkeit wird beim Auswählen geprüft."
    L["ATT_SEARCH_PURCHASE_TT"] = "Du kannst diese Bezugsquelle besuchen. Für den Kauf kann weiterer Ruf oder Ruhm erforderlich sein."
    ...
    L["ACQUISITION_HELP"] = "So erhältlich"
    L["ACQUISITION_CLICK_HINT"] = "Linksklick: Details in ATT, sofern verfügbar. Rechtsklick: QuickRoute-Bezugsquellen und Weg dorthin."
    L["ACQUISITION_VENDOR_ROUTE"] = "Weg zum Händler"
    L["ACQUISITION_VENDOR_UNKNOWN"] = "Für diese Bezugsquelle ist noch keine genaue Position bekannt."
    L["ACQUISITION_COPY_LINK"] = "Details auf Wowhead: Link markieren und Strg+C drücken."
    L["ACQUISITION_ATT_HINT"] = "Optional: ALL THE THINGS ergänzt Gegenstands-Tooltips um Sammlungsdetails und Bezugsquellen."
    L["ACQUISITION_OPEN_ATT"] = "In ATT öffnen"
    L["ACQUISITION_ATT_UNAVAILABLE"] = "ATT konnte diesen Eintrag nicht öffnen. Hier stehen die verfügbaren Angaben zur Beschaffung."
    L["ACQUISITION_SOURCE"] = "Bezugsquelle"
    L["ACQUISITION_SOURCE_ROUTE"] = "Weg zur Bezugsquelle"
    L["ACQUISITION_ATT_SOURCE"] = "Eine in ALL THE THINGS hinterlegte Bezugsquelle"
    L["ACQUISITION_NPC_FALLBACK"] = "NSC %d"
    L["ACQUISITION_QUEST_GROUP"] = "Vorausgesetzte Quests (%d von %d): %s"
    L["ACQUISITION_COST"] = "Kosten"
    L["STATUS_UNAVAILABLE"] = "Nicht nutzbar"
    ...
    L["DEST_RANDOM_DELVE"] = "Zufällige Tiefe"
    ...
    -- Acquisition requirement labels
    L["ACQUISITION_UNOBTAINABLE"] = "Derzeit nicht erhältlich"
    L["ACQUISITION_UNOBTAINABLE_SHORT"] = "Nicht erhältlich"
    L["ACQUISITION_REPUTATION_MIN"] = "%s: mindestens %g Ruf"
    L["ACQUISITION_REPUTATION_MAX"] = "%s: weniger als %g Ruf"
    L["ACQUISITION_RENOWN_MIN"] = "%s: Ruhmstufe %g erforderlich"
    L["ACQUISITION_FACTION_FALLBACK"] = "Fraktion %d"
    L["ACQUISITION_UNOBTAINABLE_HINT"] = "Laut ALL THE THINGS ist dieser Teleport über die hinterlegten Bezugsquellen derzeit nicht mehr erhältlich. Bereits erlernte Teleports bleiben nutzbar."
...
if GetLocale() == "frFR" then
    ...
    -- Acquisition requirement labels
    L["ACQUISITION_UNOBTAINABLE"] = "Impossible à obtenir actuellement"
    L["ACQUISITION_UNOBTAINABLE_SHORT"] = "Indisponible"
    L["ACQUISITION_REPUTATION_MIN"] = "%s : réputation d'au moins %g"
    L["ACQUISITION_REPUTATION_MAX"] = "%s : réputation inférieure à %g"
    L["ACQUISITION_RENOWN_MIN"] = "%s : renom %g requis"
    L["ACQUISITION_FACTION_FALLBACK"] = "Faction %d"
    L["ACQUISITION_UNOBTAINABLE_HINT"] = "Selon ALL THE THINGS, les sources répertoriées ne permettent plus d'obtenir cette téléportation. Les téléportations déjà apprises restent utilisables."
...
if esLocale == "esES" or esLocale == "esMX" then
    ...
    -- Acquisition requirement labels
    L["ACQUISITION_UNOBTAINABLE"] = "Actualmente no se puede obtener"
    L["ACQUISITION_UNOBTAINABLE_SHORT"] = "No obtenible"
    L["ACQUISITION_REPUTATION_MIN"] = "%s: al menos %g de reputación"
    L["ACQUISITION_REPUTATION_MAX"] = "%s: menos de %g de reputación"
    L["ACQUISITION_RENOWN_MIN"] = "%s: se requiere renombre %g"
    L["ACQUISITION_FACTION_FALLBACK"] = "Facción %d"
    L["ACQUISITION_UNOBTAINABLE_HINT"] = "Según ALL THE THINGS, las fuentes registradas ya no permiten obtener este teletransporte. Los teletransportes ya aprendidos siguen siendo utilizables."
...
if GetLocale() == "ptBR" then
    ...
    -- Acquisition requirement labels
    L["ACQUISITION_UNOBTAINABLE"] = "Não pode ser obtido atualmente"
    L["ACQUISITION_UNOBTAINABLE_SHORT"] = "Não obtível"
    L["ACQUISITION_REPUTATION_MIN"] = "%s: pelo menos %g de reputação"
    L["ACQUISITION_REPUTATION_MAX"] = "%s: menos de %g de reputação"
    L["ACQUISITION_RENOWN_MIN"] = "%s: Renome %g necessário"
    L["ACQUISITION_FACTION_FALLBACK"] = "Facção %d"
    L["ACQUISITION_UNOBTAINABLE_HINT"] = "Segundo o ALL THE THINGS, as fontes registradas não permitem mais obter este teletransporte. Teletransportes já aprendidos continuam utilizáveis."
...
if GetLocale() == "ruRU" then
    ...
    -- Acquisition requirement labels
    L["ACQUISITION_UNOBTAINABLE"] = "Сейчас нельзя получить"
    L["ACQUISITION_UNOBTAINABLE_SHORT"] = "Недоступно"
    L["ACQUISITION_REPUTATION_MIN"] = "%s: требуется не менее %g репутации"
    L["ACQUISITION_REPUTATION_MAX"] = "%s: репутация ниже %g"
    L["ACQUISITION_RENOWN_MIN"] = "%s: требуется известность %g"
    L["ACQUISITION_FACTION_FALLBACK"] = "Фракция %d"
    L["ACQUISITION_UNOBTAINABLE_HINT"] = "По данным ALL THE THINGS, указанные источники больше не позволяют получить этот телепорт. Ранее изученные телепорты по-прежнему можно использовать."
...
if GetLocale() == "koKR" then
    ...
    -- Acquisition requirement labels
    L["ACQUISITION_UNOBTAINABLE"] = "현재 획득 불가"
    L["ACQUISITION_UNOBTAINABLE_SHORT"] = "획득 불가"
    L["ACQUISITION_REPUTATION_MIN"] = "%s: 평판 %g 이상 필요"
    L["ACQUISITION_REPUTATION_MAX"] = "%s: 평판 %g 미만 필요"
    L["ACQUISITION_RENOWN_MIN"] = "%s: 영예 %g 필요"
    L["ACQUISITION_FACTION_FALLBACK"] = "진영 %d"
    L["ACQUISITION_UNOBTAINABLE_HINT"] = "ALL THE THINGS에 따르면 기록된 획득처에서는 더 이상 얻을 수 없습니다. 이미 배운 순간이동은 계속 사용할 수 있습니다."
    L["REQ_REPUTATION"] = "평판"
    L["REQ_QUEST"] = "퀘스트"
...
if GetLocale() == "zhCN" then
    ...
    -- Acquisition requirement labels
    L["ACQUISITION_UNOBTAINABLE"] = "当前无法获取"
    L["ACQUISITION_UNOBTAINABLE_SHORT"] = "无法获取"
    L["ACQUISITION_REPUTATION_MIN"] = "%s：需要至少 %g 点声望"
    L["ACQUISITION_REPUTATION_MAX"] = "%s：声望须低于 %g"
    L["ACQUISITION_RENOWN_MIN"] = "%s：需要达到名望 %g 级"
    L["ACQUISITION_FACTION_FALLBACK"] = "阵营 %d"
    L["ACQUISITION_UNOBTAINABLE_HINT"] = "根据 ALL THE THINGS 的记录，目前已无法通过所列来源获取此传送。已经学会的传送仍可使用。"
    L["REQ_REPUTATION"] = "声望"
    L["REQ_QUEST"] = "任务"
...
if GetLocale() == "zhTW" then
    ...
    -- Acquisition requirement labels
    L["ACQUISITION_UNOBTAINABLE"] = "目前無法取得"
    L["ACQUISITION_UNOBTAINABLE_SHORT"] = "無法取得"
    L["ACQUISITION_REPUTATION_MIN"] = "%s：需要至少 %g 點聲望"
    L["ACQUISITION_REPUTATION_MAX"] = "%s：聲望須低於 %g"
    L["ACQUISITION_RENOWN_MIN"] = "%s：需要達到名望 %g 級"
    L["ACQUISITION_FACTION_FALLBACK"] = "陣營 %d"
    L["ACQUISITION_UNOBTAINABLE_HINT"] = "根據 ALL THE THINGS 的紀錄，目前已無法透過所列來源取得此傳送。已經學會的傳送仍可使用。"
    L["REQ_REPUTATION"] = "聲望"
    L["REQ_QUEST"] = "任務"
    L["REQ_ACHIEVEMENT"] = "成就"
    L["REQ_COMPLETE"] = "已完成"
...
if GetLocale() == "itIT" then
    ...
    -- Acquisition requirement labels
    L["ACQUISITION_UNOBTAINABLE"] = "Attualmente non ottenibile"
    L["ACQUISITION_UNOBTAINABLE_SHORT"] = "Non ottenibile"
    L["ACQUISITION_REPUTATION_MIN"] = "%s: almeno %g reputazione"
    L["ACQUISITION_REPUTATION_MAX"] = "%s: reputazione inferiore a %g"
    L["ACQUISITION_RENOWN_MIN"] = "%s: richiesta Fama %g"
    L["ACQUISITION_FACTION_FALLBACK"] = "Fazione %d"
    L["ACQUISITION_UNOBTAINABLE_HINT"] = "Secondo ALL THE THINGS, le fonti registrate non permettono più di ottenere questo teletrasporto. I teletrasporti già appresi restano utilizzabili."
