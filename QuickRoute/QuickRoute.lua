...
local function PrintHelp()
    ...
    print("  /qrverifymap [mapID] - What the client and the addon each say about a map")
    print("  /qrwpcost - What resolving each tracked quest's waypoint costs, cold and warm")
