...
┌──────────────────────────────────────────────────────────────┐
│  ┌──────┐                                                    │
│  │ 28×28 │  1. Use [Hearthstone]          [icon] [Nav]  │
...
| Use button overlay | 38×22 text button    | 28×28 icon (matches step icon style)     |
...
- Use overlay: 28×28 icon, left of Nav, same vertical offset
